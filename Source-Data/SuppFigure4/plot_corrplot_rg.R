...
TRAIT_CATEGORY1 = c(
  ...
  'Liver-related', 'Other biochemical', 'Hematological', 'Blood pressure', 'Echocardiographic', "Disease"
)

# diseases
TRAIT_CATEGORY2 = c(
  'Metabolic disease', 'Cardiovascular disease', 'Allergic disease', 'Autoimmune disease', 'Infectious disease',
  'Hematologic disease', 'Psychiatric disease', 'Musculoskeletal disease', 'Tumor', 'Other', "Disease"
)

TRAIT_CATEGORY1 = c(TRAIT_CATEGORY1, TRAIT_CATEGORY2)
TRAIT_CATEGORY2 = TRAIT_CATEGORY1
...
corrplot_nsquare = function(rg, trait1, trait2, traits_use = NULL, order = "original", landscape=FALSE) {
  ...
  corrplot(mat2, method = "psquare", order = order,
           ...
           col= colorRampPalette(c('#313695',"white", '#A50026'))(10) )
  # return(list(mat = mat2, qmat = qmat2))
}

cairo_pdf("./output/corrplot_rg_disease7.pdf", width = 6, height = 6, family = "Helvetica")
